      ...
      <div className="container mx-auto">
        <nav className="sticky top-0 z-50 flex items-center justify-between p-2 shadow-lg">
          <div className="flex gap-2 items-center">
            ...
            <span className="text-lg font-serif">Blogs</span>
          </div>
              ...
              <DropdownMenu.Root>
                ...
                <DropdownMenu.Content className="flex flex-col gap-2 bg-white shadow-[0px_0px_3px_1px_#f7fafc]  border-black border-2 text-black mr-5 w-40 duration-500 font-semibold p-2 rounded-md mt-2">
                  ...
                  <DropdownMenu.Item className="outline-none">
                    <button
                      onClick={Logout}
                      className="p-1 font-mono font-semibold text-black bg-white rounded-md flex items-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
          ...
          <div className="pt-1 md:hidden lg:hidden duration-500">
        ...
        {isMobile && (
          <>
            <div className="sticky  z-50 flex flex-col text-black items-start gap-3  bg-white top-14 md:hidden lg:hidden ">
              <div className="flex gap-2 flex-col w-full">
                <div className="flex items-center gap-2   z-50">
                  <DropdownMenu.Root>
                    <DropdownMenu.Trigger className="outline-none w-full">
                      <div className="flex gap-2 text-justify border-b-2 pb-2 border-black w-full">
                        <button>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="32"
                ...
                <div className=" w-full flex flex-col gap-2 text-lg font-semibold ">
